 ...
 */
public class TTTAIGame implements Game {
    ...
    static public boolean setAI;

    /** constructor that gets the number of players */
    public TTTAIGame(int numPlayers) {
    ...
    public String getTitle() {
        return "2-way Tic Tac Toe aganist AI";
    }
    ...
    public void addMove(Coordinate pos) {
        ...
        if (this.currentPlayer == this.numPlayers) {
            ...
            this.currentPlayer++; //This should trigger the AI TODO
        }
    }
